...
checkoutBtn.addEventListener("click", () => {
  if (!validateContact()) {
    ...
    if (warning) {
      warning.textContent = "⚠️ Please fill out all required contact and shipping details before proceeding.";
      setTimeout(() => (warning.textContent = ""), 4000); // clears after 4 seconds
    }
    return;
  }
